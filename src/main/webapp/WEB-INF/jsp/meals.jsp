...
<body>
<script type="text/javascript" src="resources/js/dtUtil.js" defer></script>
...
<div class="modal fade" id="editRowm">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsFormm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="date" class="form-control" id="dateTime" name="dateTime" placeholder="<spring:message code="meal.dateTime"/>">
                        </div>
                    </div>
